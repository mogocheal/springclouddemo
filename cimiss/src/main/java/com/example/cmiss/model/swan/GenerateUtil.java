...
public class GenerateUtil {
     ...
     * @throws Exception
     */
    public static GenerateInfo GenerateSwanPic(String filePath, SwanDataSet.ProductType type,
                                               boolean isMercator, double zoomFactor, ArrayList<Double> clipX,
                                               ArrayList<Double> clipY, int bmpWidth) throws Exception {
        ...
        BufferedImage bfImage = drawGridPic(bmpWidth, null, gridX, gridY,
                data1, SwanDataSet.valueNa);
